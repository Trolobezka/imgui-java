...
abstract class ApiArg(
    ...
    class Float(name: String, optional: Boolean, default: String?) : Primitive(name, optional, default)
    ...
    abstract class PrimitiveWrapper(name: String, optional: Boolean, default: String?) :
        ApiArg(name, optional, default) {
    ...
    class Struct(private val type: String, name: String, optional: Boolean, default: String?) :
        ApiArg(name, optional, default) {
    ...
    open class ImVec2(name: String, optional: Boolean, default: String?) : ApiArg(name, optional, default),
        AlternateArgJava {
    ...
    open class ImVec4(name: String, optional: Boolean, default: String?) : ApiArg(name, optional, default),
        AlternateArgJava {
        ...
        override fun getAlternativeArgJava(): ApiArg {
            return object : ImVec4(name, optional, default) {
                override fun inSignatureJava() = "final float ${name}X, final float ${name}Y, final float ${name}Z, final float ${name}W"
                override fun inBodyJava() = "${name}X, ${name}Y, ${name}Z, ${name}W"
            }
        }
    }
