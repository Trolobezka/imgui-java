...
abstract class ApiResultImVec(type: String) : ApiResult(type)

class ApiResultImVec2 : ApiResultImVec("imgui.ImVec2")
class ApiResultImVec4 : ApiResultImVec("imgui.ImVec4")
